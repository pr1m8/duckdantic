...
from temp_pr_bundles.PRs.structdantic.fields import FieldOrigin, FieldView
from temp_pr_bundles.PRs.structdantic.providers.base import Capabilities, FieldProvider


class AttrsProvider(FieldProvider):
