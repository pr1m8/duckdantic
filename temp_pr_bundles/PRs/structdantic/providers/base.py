...
def register_default_providers() -> None:
    ...
    if _defaults_added:
        return
    from temp_pr_bundles.PRs.structdantic.providers.attrs import AttrsProvider
    from temp_pr_bundles.PRs.structdantic.providers.dataclass import DataclassProvider
    from temp_pr_bundles.PRs.structdantic.providers.mapping import MappingProvider
    from temp_pr_bundles.PRs.structdantic.providers.plainclass import PlainClassProvider
    from temp_pr_bundles.PRs.structdantic.providers.pydantic_v2 import (
        PydanticV2Provider,
    )
    from temp_pr_bundles.PRs.structdantic.providers.typeddict import TypedDictProvider
